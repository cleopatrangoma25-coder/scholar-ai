  ...
  try {
    ...
    if (exists) {
      ...
      if (files.length === 0) {
        ...
        console.log('\n✅ Bucket has documents! The RAG system should be able to access them.');
        console.log('If you\'re still getting fallback responses, there might be a permissions issue.');
      }
    } else {
